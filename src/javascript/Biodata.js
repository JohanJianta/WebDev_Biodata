...
function Biodata() {
  ...
  const containerTombolPicture = createElement(
    "div",
    { className: "Tombol-container Flex-Tengah" },
    [
      createElement(
        ToggleButton,
        { toggleFunction: setPicture },
        "Tampilkan Gambar"
      ),
    ]
  );

  const bodyKiri = createElement("div", { className: "Body-kiri" }, [
    image,
    containerTombolPicture,
    createElement("li", null, "Pria"),
    createElement("li", null, "Mahasiswa"),
  ]);

  const containerName = createElement("div", null, [
    createElement("p", { className: "Header-name" }, "Johan Reinaldo Jianta"),
    createElement("hr", { className: "Garis-name" }),
  ]);

  const angkatan = createElement(
    Accordion,
    {
      title: "Angkatan",
  ...
  const jalurSukses = createElement(
    Accordion,
    {
      title: "Jalur Sukses",
  ...
  const listInfo = createElement("div", { className: "List-info" }, [
    angkatan,
    jurusan,
    jalurSukses,
    hobi,
  ...
  const bodyKanan = createElement(
    "div",
    { className: "Body-kanan Flex-Tengah" },
    [containerName, listInfo]
  );

  const bodyAtas = createElement("div", { className: "App-body" }, [
    bodyKiri,
    bodyKanan,
  ]);

  const containerRiwayat = createElement("div", { className: "Bawah-child" }, [
  ...
  const containerTombolBorder = createElement(
    "div",
    { className: "Bawah-child Tombol-container Flex-Tengah" },
  ...
  return createElement("div", { className: "Biodata" }, [
    bodyAtas,
